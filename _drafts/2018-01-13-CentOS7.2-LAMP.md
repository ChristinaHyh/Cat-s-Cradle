---
layout: post
title: 'Install LAMP Stack on CentOS 7.2'
date: 2018-01-13
author: Christina
lang: en
tags: Machine
...
1.Installing [MySQL](https://dev.mysql.com/downloads/mysql/)
 ...
 ```css
    ...
    # cd /usr/local/mysql
    # mkdir -p /data/mysql  //Create "datadir" to store database files
...
2.Installing Apache
 ...
 ```css
    ...
    //Install the function library that httpd depends on: apr、apr-util
    ...
    # make && make install  //Compile and install apr
    ...
    //Install some library files may be used
...
3.Installing PHP
 ...
 ```css
    ...
    //Install some packages may be used
